...
/* Generated from ../O.Common/xcamCameraApp.dbd */
...
epicsShareExtern void (*pvar_func_RIXSCamRegister)(void);
...
extern "C" void (*pvar_func_NDPluginXIPRegister)(void);
...
int xcamCameraApp_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "D:/Development/Clients/XCAM/EPICS/synApps/synApps_5_8/support/areaDetector-R2-4/ADxcam/iocs/xcamCameraIOC";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"xcamCameraApp_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    xcamCameraApp_registerRecordDeviceDriver(*iocshPpdbbase);
}
